...
if __name__ == "__main__":
    ...
    if args.type == 1:
        ...
        viz.create_imgs_from_csv_results(
            args.input_csv, args.output_folder, args.num_imgs
        )
    elif args.type == 3:
        ...
        dataset = BenchmarkDataset(
            args.input_csv,
            problem_specs["control_intervals"],
            problem_specs["num_obstacles"],
            problem_specs["num_constraints"],
        )
        dataiter = iter(dataset)

        problem, x_var, u_var, x0_param, obst_param, t_param = generate_problem(
            problem_specs["control_intervals"],
            problem_specs["interval_duration"],
        ...
        for i, sample in enumerate(dataiter):
            ...
            viz.save_compared_trajectories(
                x0, obstacles, unrolled_x, sample["gt_x"], f"unrollled{i}.jpg"
            )
