...
class OnlineTrainer:
    ...
    def __init__(self, layers, learning_rate, convergence_threshold, act_fn, debug_mode, n):
        ...
        if not self.debug_mode:
            self.run = wandb.init(project='learning_warmstarts', entity='laine-lab', config=config, job_type='online-train')
    ...
    def train(self):
        ...
        while i < self.n:
            ...
            obsts = np.array(generate_obstacles(problem_specs['num_obstacles'],problem_specs['lane_width'], problem_specs['car_horizon'], problem_specs['car_width'], x0))
